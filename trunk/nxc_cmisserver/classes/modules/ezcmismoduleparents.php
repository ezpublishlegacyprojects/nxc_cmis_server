<?php
/**
 * Definition of eZCMISModuleParents class
 *
...
/**
 * Handles operations on object parents feed
 *
 * @services:
 *     GET: getObjectParents
 *
 * @file ezcmismoduleparents.php
 */

include_once( eZExtension::baseDirectory() . '/ezcmis/classes/modules/ezcmismodulebase.php' );

class eZCMISModuleParents extends eZCMISModuleBase
{
    /**
    ...
    {
        return $this->processService( 'getObjectParents' );
    }
