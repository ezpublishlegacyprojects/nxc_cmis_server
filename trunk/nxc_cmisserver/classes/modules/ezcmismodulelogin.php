<?php
/**
 * Definition of eZCMISModuleLogin class
 *
...
/**
 * Handles operations on login
 *
 * @note: it is not CMIS standard
 * @file ezcmismodulelogin.php
 */

include_once( eZExtension::baseDirectory() . '/nxc_cmisserver/classes/modules/ezcmismodulebase.php' );

class eZCMISModuleLogin extends eZCMISModuleBase
{
    /**
    ...
    {
        return $this->processService( 'login' );
    }
