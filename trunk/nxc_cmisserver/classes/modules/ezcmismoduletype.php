<?php
/**
 * Definition of eZCMISModuleType class
 *
...
/**
 * Handles operations on type entry
 *
 * @services:
 *     GET: getTypeDefinition
 *
 * @file ezcmismoduletype.php
 */

include_once( eZExtension::baseDirectory() . '/ezcmis/classes/modules/ezcmismodulebase.php' );

class eZCMISModuleType extends eZCMISModuleBase
{
    /**
    ...
    {
        return $this->processService( 'getTypeDefinition' );
    }
