<?php
/**
 * Definition of eZCMISModuleTypes class
 *
...
/**
 * Handles operations on type collection
 *
 * @services:
 *     GET: getTypeDescendants
 *
 * @TODO: Perhaps getTypeChildren service is needed there as well
 * @file ezcmismoduletypes.php
 */

include_once( eZExtension::baseDirectory() . '/nxc_cmisserver/classes/modules/ezcmismodulebase.php' );

class eZCMISModuleTypes extends eZCMISModuleBase
{
    /**
    ...
    {
        return $this->processService( 'getTypeDescendants' );
    }
