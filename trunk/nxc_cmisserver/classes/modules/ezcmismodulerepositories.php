<?php
/**
 * Definition of eZCMISModuleRepositories class
 *
...
/**
 * Handles operations on repository collection
 *
 * @services:
 *     GET: getRepositories
 *
 * @file ezcmismodulerepositories.php
 */

include_once( eZExtension::baseDirectory() . '/nxc_cmisserver/classes/modules/ezcmismodulebase.php' );

class eZCMISModuleRepositories extends eZCMISModuleBase
{
    /**
    ...
    {
        return $this->processService( 'getRepositories' );
    }
