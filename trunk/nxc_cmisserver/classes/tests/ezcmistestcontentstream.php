<?php
/**
 * Definition of eZCMISTestContentStream class
 *
...
/**
 * Tests fetching of object content stream
 *
...
class eZCMISTestContentStream extends eZCMISTestBase
{
    /**
     * @reimp
     */
    protected function test()
    {
        ...
        $title = 'TestContentStream title ' . rand();
        $summary = 'Summary ' . $title;
        $contentType = 'text/plain';
        $content = 'Document content stream';
        ...
        /***************************
         * 2. Fetch content stream *
         ***************************/

        $result = $this->httpRequest( $mediaLink, $this->User, $this->Password, array(), 'GET', array() );
        $this->checkCode( '200', $result->code, 'GET', $mediaLink, $result->response );
    }
}
?>
