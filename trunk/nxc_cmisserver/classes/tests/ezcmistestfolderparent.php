<?php
/**
 * Definition of eZCMISTestFolderParent class
 *
...
/**
 * Tests fetching of folder parent
 *
 * @file ezcmistestfolderparent.php
 */
...
class eZCMISTestFolderParent extends eZCMISTestBase
{
    /**
     * @reimp
     */
    protected function test()
    {
        ...
        $title = 'TestFolderParent title ' . rand();
